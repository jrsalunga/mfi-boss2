...
class UIBom extends DatabaseObject{
	...
	protected static $db_fields = array('id', 'catcode' , 'catname', 'itemcode' ,'itemname', 'avecost', 'bomcost', 'uom', 'qty', 'qtyused', 'totamt');
	...
	*/
	...
	public static function getBom($projectid){
		...
		$sql .= "b.descriptor as itemname, b.uom, b.avecost, a.qty, ";
